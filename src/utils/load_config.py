...
# NOTE THAT SOME OF THE CONFIG INFO IS NOT USED
...
print("Environment variables are loaded (not required because the aws credentials are alr in a config file):", load_dotenv())
